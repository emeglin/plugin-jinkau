...
class Anthologize_Project_Organizer {
	...
	function display() {
		...
		<div class="wrap anthologize" id="project-<?php echo esc_attr( $_GET['project_id'] ) ?>">
			...
			<div id="anthologize-logo">
				<img src="<?php echo esc_url( plugins_url() . '/anthologize/images/logo-jinkau-300px.png' ) ?>" />
			</div>
			...
			<h2>
				...
				<div id="project-actions">
					<a href="admin.php?page=anthologize_new_project&project_id=<?php echo esc_attr( $this->project_id ) ?>"><?php _e( 'Détails du projet', 'anthologize' ) ?></a> |
					<a target="_blank" href="<?php echo esc_url( $this->preview_url( $this->project_id, 'anth_project' ) ) ?>"><?php _e( 'Aperçu du projet', 'anthologize' ) ?></a> |
	...
	function sortby_dropdown() {
		...
		<span><?php _e( 'Filtrer par', 'anthologize' ) ?></span>
				...
				<li class="part" id="part-<?php echo esc_html( $part_id ) ?>">
					<h3 class="part-header">
						...
						<div class="part-buttons">
							...
							<a target="_blank" href="<?php echo esc_url( $this->preview_url( get_the_ID(), 'anth_part' ) ) ?>" class=""><?php _e( 'Aperçu', 'anthologize' ) ?></a> |
			...
			<h3 class="part-item">
				...
				<div class="part-item-buttons">
					...
					*/ ?>
					...
					<a target="new" href="<?php echo esc_url( $this->preview_url( get_the_ID(), 'anth_library_item' ) ) ?>" class=""><?php _e( 'Aperçu', 'anthologize' ) ?></a><span class="toggle-sep"> |</span>
